...
<head>
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="../admin/Public/admin/plugins/summernote/summernote-bs4.css">
...
<body class="hold-transition sidebar-mini layout-fixed" >
    ...
    <div class="wrapper">
        ...
        <!-- <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="../admin/Public/admin/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div> -->
        <!-- Navbar -->
