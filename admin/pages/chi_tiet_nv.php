                        ...
                        <div class="card-body">
                            <form method="post">
                                ...
                                if (isset($_POST['btn'])) {
                                    ...
                                    // }
                                    $luong = 3;
                                    $sql = "UPDATE nhan_vien SET Hoten='$ten',Ngaysinh='$ngaysinh',ID_bophan='$bophan',He_so_luong='$luong',Ma_bo='$mabo',Ma_nhom='$manhom',username='$email', pass ='$password' WHERE Ma_nv='$manv'";
                                    $result = mysqli_query($conn, $sql) or die( "Có lỗi xảy ra: " . mysqli_error($conn));
                                    if ($result == true) {
