...
<style>
    ...
    .action-buttons .btn:hover {
        background: #e9ecef;
        color: #495057; /* Màu xám đậm hơn khi hover */
    ...
    .action-buttons select.form-control-sm {
        width: auto; /* Cho phép select box co lại theo nội dung */
    ...
    @media (max-width: 768px) {
        .action-buttons select.form-control-sm {
            min-width: 120px; /* Giảm độ rộng tối thiểu trên mobile */
        }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="list-group" id="employeeList">
                    ...
                    $employees = $conn->query("SELECT id, username FROM users WHERE role = 1"); // Giả sử role = 1 là nhân viên
