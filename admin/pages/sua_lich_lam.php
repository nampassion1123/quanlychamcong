        ...
        WHERE nv.ID_bophan = '$Idbp' 
          ...
          AND YEAR(pcl.ngay) = '$currentYear'";
                        ...
                        <style>
                                ...
                                table-layout: fixed; /* Tự động điều chỉnh chiều rộng các cột */
                            }
                            td {
                            ...
                            th.namenv{
                                width: 30%; /* Chiều rộng cố định cho cột tên nhân viên */
                            }
                            th.namenv, th.thdate{
                                background: #e9984c;
                            }
                            th {
                                width: 8%; /* Đặt chiều rộng cho cột ngày */
                            }
                            td,th {
                                text-align: center; /* Căn giữa nội dung trong ô */
                            }
                            td.tdname {
                                white-space: normal; /* Cho phép nội dung xuống dòng trong cột tên */
                            }
                            </style>
